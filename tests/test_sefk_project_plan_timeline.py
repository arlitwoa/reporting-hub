...
class SefkProjectPlanTimelineTests(unittest.TestCase):
    ...
    def test_html_report_includes_search_controls_and_search_logic(self) -> None:
        ...
        self.assertIn('data-status-category="To Do"', html_doc)
        self.assertIn('data-status-category="In Progress"', html_doc)
        self.assertIn('data-status-category="Done"', html_doc)
        self.assertNotIn('data-overdue-filter="1"', html_doc)
        self.assertIn('data-rag-severity="green"', html_doc)
